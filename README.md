...
> **Note:** This repository is a fork of the [Liquid4All cookbook](https://github.com/Liquid4All/cookbook/tree/main/examples/audio-transcription-cli) example. The original project is maintained by the Liquid AI team — head there for the latest upstream changes.
>
> In this fork, the following improvements were made:
>
> - Added mic recording support (`--mic` mode) — see [src/audio_transcription_cli/transcribe.py](src/audio_transcription_cli/transcribe.py)
> - Improved inline documentation in [examples.sh](examples.sh) with flag references and prerequisite instructions
...
1. Clone the repository
    ```sh
    git clone https://github.com/mnikiema/audio-transcription-cli.git
...
In the [examples.sh](./examples.sh) script you will find 3 examples on how to run inference with LFM2-Audio-1.5 for 3 common use cases:
